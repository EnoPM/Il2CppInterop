...
namespace Il2CppInterop.Runtime.Runtime.VersionSpecific.Class
{
    ...
    public unsafe class NativeClassStructHandler_24_3 : INativeClassStructHandler
    {
        ...
        public INativeClassStruct CreateNewStruct(int vTableSlots)
        {
            ...
            Il2CppClass_24_3* _ = (Il2CppClass_24_3*)ptr;
            *_ = default;
        ...
        internal class NativeStructWrapper : INativeClassStruct
        {
            ...
            private static int _bitfield0offset = Marshal.OffsetOf<Il2CppClass_24_3>(nameof(Il2CppClass_24_3._bitfield0)).ToInt32();
            private static int _bitfield1offset = Marshal.OffsetOf<Il2CppClass_24_3>(nameof(Il2CppClass_24_3._bitfield1)).ToInt32();
            public IntPtr Pointer { get; }
            private Il2CppClass_24_3* _ => (Il2CppClass_24_3*)Pointer;
            public IntPtr VTable => IntPtr.Add(Pointer, sizeof(Il2CppClass_24_3));
            ...
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_valuetype);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_valuetype, value);
            }
            public bool Initialized
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_initialized);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_initialized, value);
            }
            public bool EnumType
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_enumtype);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_enumtype, value);
            }
            public bool IsGeneric
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_is_generic);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_is_generic, value);
            }
            public bool HasReferences
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_has_references);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_has_references, value);
            }
            public bool SizeInited
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_size_inited);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_size_inited, value);
            }
            public bool HasFinalize
            {
                get => this.CheckBit(_bitfield1offset, (int)Il2CppClass_24_3.Bitfield1.BIT_has_finalize);
                set => this.SetBit(_bitfield1offset, (int)Il2CppClass_24_3.Bitfield1.BIT_has_finalize, value);
            }
            public bool IsVtableInitialized
            {
                get => this.CheckBit(_bitfield1offset, (int)Il2CppClass_24_3.Bitfield1.BIT_is_vtable_initialized);
                set => this.SetBit(_bitfield1offset, (int)Il2CppClass_24_3.Bitfield1.BIT_is_vtable_initialized, value);
            }
            public bool InitializedAndNoError
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_initialized_and_no_error);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_24_3.Bitfield0.BIT_initialized_and_no_error, value);
            }
        }
